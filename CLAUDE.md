...
- Built output: `packages/core/dist/` (committed for direct `file:` dependency consumption)
...
**After any source change, you must rebuild dist/ and commit it.**
...
- Always rebuild and commit dist/ after source changes
